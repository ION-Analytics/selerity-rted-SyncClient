 ...
 *
 */
public class PaginatedResponseIterator {
	private static final Log log = LogFactory.getLog (PaginatedResponseIterator.class);
	 ...
	 * @param limit
	 */
	public PaginatedResponseIterator(Dispatcher dispatcher, Session session,
